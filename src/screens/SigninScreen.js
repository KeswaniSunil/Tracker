...
//One thing to notice that this screen will not have any header coz we have not added it in second args in App.js ,if we want
//we can write:- 
...
const SigninScreen=()=>{
    ...
    const {state,signin , clearErrOnScreenSwicth}=useContext(AuthContext);
